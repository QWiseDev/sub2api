export default {
    accounts: {
      ...
      openai: {
        ...
        responsesModeDesc:
          'Only applies to the OpenAI API Key text forwarding path. Auto preserves the client endpoint; the Responses probe only decides whether /responses must fall back.',
